        ...
        <br></br>
           ...
           <div className="productDescriptionContainer">
            ...
            <div className="breed">
                ...
                <li><a href="#">Products</a><IoIosArrowForward /></li>
                <li><a href="#">Details</a><IoIosArrowForward /></li>
            ...
            <div className="productDetails">
                ...
                <span className="ratingNumbersReviews">1234 Ratings & 140 Reviews</span>
                </div>
                <div className="extraOffer">Extra <MdEuroSymbol />0.50 off </div>
                <div className="flexRow priceContainer">
                <span className="price"><MdEuroSymbol />{product.productDetails.price}</span>
